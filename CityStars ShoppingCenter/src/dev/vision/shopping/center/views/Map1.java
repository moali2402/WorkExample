...
public class Map1 extends BasicMap {
	...
	// to add
	Point path11= new Point(280, 513, TYPE.PATH);
	Point path12= new Point(245, 475, TYPE.PATH);
	Point path13= new Point(215, 475, TYPE.PATH);
	Point path14= new Point(215, 405, TYPE.PATH);
	...
	public Map1(Context context, AttributeSet attrs) {
		super(context, attrs);
		setup();
	}

	public Map1(Context context, AttributeSet attrs, int defStyle) {
