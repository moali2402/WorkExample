...
public class GiftCardFragment extends Fragment implements OnTabChangeListener {
	TabHost tabs;
	private View v;
	int posi;
	SwipeListView lv;
	...
	public static GiftCardFragment NewInstance(int pos) {
		GiftCardFragment d =new GiftCardFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		v= inflater.inflate(R.layout.giftcards, null);
