...
public class Fragment_Cars extends BaseFragment_SubCat {
	...
	public static Fragment_Cars newInstance() {
		Fragment_Cars smf = new Fragment_Cars();
		smf.TITLE = "CARS";
		smf.TITLE_ARABIC = "سـيارات";
		smf.ICON = R.drawable.cars;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("VBQ9fhNCyq");
