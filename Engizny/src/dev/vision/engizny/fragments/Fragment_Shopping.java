...
public class Fragment_Shopping extends BaseFragment_SubCat {
	...
	public static Fragment_Shopping newInstance() {
		Fragment_Shopping smf = new Fragment_Shopping();
		smf.TITLE = "SHOPPING";
		smf.TITLE_ARABIC = "تـسوق";
		smf.ICON = R.drawable.trolley;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("yM5iQWnMzc");
