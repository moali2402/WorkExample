...
public class Fragment_Pets extends BaseFragment_SubCat {
	...
	public static Fragment_Pets newInstance() {
		Fragment_Pets smf = new Fragment_Pets();
		smf.TITLE = "PETS";
		smf.TITLE_ARABIC = "حـيوانات";
		smf.ICON = R.drawable.pets;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("5ugBfe7w1X");
