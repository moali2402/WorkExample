...
public class Fragment_Government extends BaseFragment_SubCat {
	
	ArrayList<SubCategory> subs = new ArrayList<SubCategory>();
	private Adapter_Subs subsAdapter;


	public Fragment_Government() {}
	
	public static Fragment_Government newInstance() {
		Fragment_Government smf = new Fragment_Government();
		smf.TITLE = "GOVERNMENT";
		smf.TITLE_ARABIC = "خـدمات حـكوميه";
		smf.ICON = R.drawable.government;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("xY60hiUbq1");
