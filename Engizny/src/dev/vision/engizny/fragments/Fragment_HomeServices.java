...
public class Fragment_HomeServices extends BaseFragment_SubCat {
	
	ArrayList<SubCategory> subs = new ArrayList<SubCategory>();
	private Adapter_Subs subsAdapter;


	public Fragment_HomeServices() {}
	
	public static Fragment_HomeServices newInstance() {
		Fragment_HomeServices smf = new Fragment_HomeServices();
		smf.TITLE = "HOME SERVICES";
		smf.TITLE_ARABIC = "خـدمات مـنزلية";
		smf.ICON = R.drawable.hservice;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("JjB5kwZsSw");
