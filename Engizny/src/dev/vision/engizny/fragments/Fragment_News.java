...
public class Fragment_News extends BaseFragment_SubCat {
	...
	public static Fragment_News newInstance() {
		Fragment_News smf = new Fragment_News();
		smf.TITLE = "NEWS";
		smf.TITLE_ARABIC = "أخـبار";
		smf.ICON = R.drawable.news;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("Y4V3YmJyXS");
