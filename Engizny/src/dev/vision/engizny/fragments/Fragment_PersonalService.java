...
public class Fragment_PersonalService extends BaseFragment_SubCat {
	
	ArrayList<SubCategory> subs = new ArrayList<SubCategory>();
	private Adapter_Subs subsAdapter;


	public Fragment_PersonalService() {}
	
	public static Fragment_PersonalService newInstance() {
		Fragment_PersonalService smf = new Fragment_PersonalService();
		smf.TITLE = "PERSONAL SERVICES";
		smf.TITLE_ARABIC = "خـدمات شـخصـية";
		smf.ICON = R.drawable.businessman;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("6L8wd8aWZP");
