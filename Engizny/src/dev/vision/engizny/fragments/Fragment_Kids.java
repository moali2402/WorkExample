...
public class Fragment_Kids extends BaseFragment_SubCat {
	
	ArrayList<SubCategory> subs = new ArrayList<SubCategory>();
	private Adapter_Subs subsAdapter;


	public Fragment_Kids() {}
	
	public static Fragment_Kids newInstance() {
		Fragment_Kids smf = new Fragment_Kids();
		smf.TITLE = "KIDS";
		smf.TITLE_ARABIC = "أطفال";
		smf.ICON = R.drawable.children;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("nC2RKsvF60");
