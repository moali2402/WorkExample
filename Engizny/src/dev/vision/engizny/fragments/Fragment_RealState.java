...
public class Fragment_RealState extends BaseFragment_SubCat {
	
	ArrayList<SubCategory> subs = new ArrayList<SubCategory>();
	private Adapter_Subs subsAdapter;


	public Fragment_RealState() {}
	
	public static Fragment_RealState newInstance() {
		Fragment_RealState smf = new Fragment_RealState();
		smf.TITLE = "REAL STATE";
		smf.TITLE_ARABIC = "عقـارات";
		smf.ICON = R.drawable.reals;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("qUByokDLGH");
