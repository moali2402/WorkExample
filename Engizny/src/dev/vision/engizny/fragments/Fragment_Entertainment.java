...
public class Fragment_Entertainment extends BaseFragment_SubCat {
	...
	public static Fragment_Entertainment newInstance() {
		Fragment_Entertainment smf = new Fragment_Entertainment();
		smf.TITLE = "ENTERTAINMENT";
		smf.TITLE_ARABIC = "التـرفيـه";
		smf.ICON = R.drawable.theatre_masks;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("iiLAh0QC90");
