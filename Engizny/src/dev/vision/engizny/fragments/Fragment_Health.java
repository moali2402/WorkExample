...
public class Fragment_Health extends BaseFragment_SubCat {
	...
	public static Fragment_Health newInstance() {
		Fragment_Health smf = new Fragment_Health();
		smf.TITLE = "HEALTH";
		smf.TITLE_ARABIC = "صحـة";
		smf.ICON = R.drawable.pharmacy_symbol;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("FARMWt82gE");
