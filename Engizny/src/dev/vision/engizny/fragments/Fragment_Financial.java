...
public class Fragment_Financial extends BaseFragment_SubCat {
	
	ArrayList<SubCategory> subs = new ArrayList<SubCategory>();
	private Adapter_Subs subsAdapter;


	public Fragment_Financial() {}
	
	public static Fragment_Financial newInstance() {
		Fragment_Financial smf = new Fragment_Financial();
		smf.TITLE = "FINANCIAL";
		smf.TITLE_ARABIC = "أمـوال";
		smf.ICON = R.drawable.nice_wallet_white;
		return smf; 
	}
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		try{
			...
			category.setObjectId("jhhPhnXIQL");
